...
namespace codenameaurora\filemanager;

use codenameaurora\filemanager\form\Form;
use codenameaurora\filemanager\form\PlayerFormResponseEvent;
...
/**
 * Class FileManager
 * @package codenameaurora\filemanager
 */
class FileManager extends PluginBase implements Listener {
    ...
    public function onResponse(PlayerFormResponseEvent $event) {
        ...
        if(!$player->hasPermission("fm.action.open")) return; # very useful line ._.
